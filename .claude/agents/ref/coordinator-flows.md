...
**Superseded by [references/coordinator-flows.md](../references/coordinator-flows.md).** Below is a legacy copy.

Fixed sequences. Coordinator Step 1 is verify task (run `/checklist`) before picking a flow.
