...
Scope: Only the install skills below. Run them in sequence; do not skip or reorder. If the user chose express in install-choices, run install-express then continue at step 3 (install-mcp). If they chose figma-console, run install-figma-bridge; otherwise skip it.
...
4. If they chose figma-console, follow [install-figma-bridge](../skills/install-figma-bridge/SKILL.md).
