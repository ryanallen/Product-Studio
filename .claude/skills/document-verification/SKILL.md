...
- **Repo structure** – README Repo Structure section and `work/paths.md` if present. Per paths.md, project deliverables are README plus any `assets/docs/` files (kebab-case names).
...
2. **Compare** – Read README Repo Structure and work/paths.md. Report: files processed but not in README/paths; paths in README/paths (including project `assets/docs/` per paths.md) not processed.
