...
5. **Report.** Output a list of files and issues (missing hierarchy, missing or non-horizontal nav, missing emoji). Hand off to **verification-documentor** with this list and the full set of files processed so it can run [document-verification](../document-verification/SKILL.md).
