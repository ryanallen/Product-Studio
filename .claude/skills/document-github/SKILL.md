...
description: GitHub README rules: GIFs, images, badges, anchors, alerts; link everything when enhancing. Use when user is writing or enhancing a GitHub README, or says enhance, make, /document-github.
