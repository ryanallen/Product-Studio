...
[work/paths.md](../../work/paths.md) – Project path. [document](../document/SKILL.md) – Documenter may add problems to README or to a doc in `assets/docs/` (kebab-case) per work/paths.md (Propose solutions workflow). [Ishikawa diagram](https://en.wikipedia.org/wiki/Ishikawa_diagram) – Cause-and-effect (fishbone) categories. Card AJ. A new tool for hazard analysis and force-field analysis: The Lovebug diagram. *Clinical Risk* 2013;19(4-5):87. [DOI 10.1177/1356262213510855](http://cri.sagepub.com/content/19/4-5/87) – Lovebug (causes + barriers), force-field, prospective and retrospective use.
